...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('初步设计以及升级概要.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('数据库文件位置.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('其他事项.html');
